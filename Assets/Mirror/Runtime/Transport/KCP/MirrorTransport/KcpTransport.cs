...
namespace kcp2k
{
    ...
    public class KcpTransport : Transport
    {
        ...
        public bool
            CongestionWindow; // KCP 'NoCongestionWindow' is false by default. here we negate it for ease of use.
        ...
        private void Awake()
        {
            ...
            // client
            client = new KcpClient(() => OnClientConnected.Invoke(),
                message => OnClientDataReceived.Invoke(message, Channels.Reliable),
                () => OnClientDisconnected.Invoke());

            // server
            server = new KcpServer(connectionId => OnServerConnected.Invoke(connectionId),
