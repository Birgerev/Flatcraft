...
namespace Mirror
{
    ...
    ///     <para>
    ///         Any object with this component on it will only be visible to the client that has been assigned authority for
    ///         it.
    ///     </para>
    ///     <para>
    ///         This would be used for spawning a non-player networked object for single client to interact with, e.g.
    ///         in-game puzzles.
    ///     </para>
    /// </summary>
